...
from .views import  student_register_request_otp, student_confirm_otp, student_login, student_register,student_list,verified_student_list,student_detail_by_id
