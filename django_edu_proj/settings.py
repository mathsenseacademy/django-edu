"""
Django settings for django_edu_proj project.
...
SECRET_KEY = 'django-insecure--f8+(nrp03iws5img%$s2k5_ba_2az*yqa7(7^i&@)m#movqd8'
...
ALLOWED_HOSTS = ["*","13.200.225.145"]
CORS_ALLOW_ALL_ORIGINS = True
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  
    "http://127.0.0.1:3000",  
    "http://192.168.99.215:3000",  
]
...
WSGI_APPLICATION = 'django_edu_proj.wsgi.application'
...
EMAIL_PORT = 465                            # Or 465 if using SSL
EMAIL_USE_TLS = False                        # Use True for port 587; False + SSL for 465
EMAIL_HOST_USER = 'mathsenseacademy.in'      # ✅ Your full email address
EMAIL_HOST_PASSWORD = 'suvadip#Math25' # ✅ Email password or app password
